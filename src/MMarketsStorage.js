import MMarketsElement from './views/MMarketsElement.js';
import { html } from './lit-html/lit-html.js';
export default class MMarketsStorage extends MMarketElement { 
    constructor() { 
        super();
...
customElements.define('mm-storage',MMarketsStorage);